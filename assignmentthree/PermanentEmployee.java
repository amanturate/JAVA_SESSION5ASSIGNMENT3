...
public class PermanentEmployee extends Employee {
	...
	public PermanentEmployee(int empId, String empName, int total_leaves,
			double basic) {
		super(empId, empName, total_leaves, basic);
		// TODO Auto-generated constructor stub
	}
int total;
	int paid_leave= 10,sick_leave= 5,casual_leave= 9;
	static double basic;
	double hra;
	double pfa;
	...
	void calculate_balance_leaves() {
		...
		System.out.println("Total Leaves Left for employee "+ empId + " is " + total);
	}
